...
import { deleteReportController, downloadReportController, generateReportController, getReportController, getReportsController, updateReportController } from '../../controllers/reports/reportController.js';
...
reportRouter.get('/:id/download', verify, downloadReportController)
